const sampleBreakerData = {
  episode: {
    ...
    image_url:
      'https://api.breaker.audio/shows/185226/episodes/29314799/image?v=1735a17353ecc0da520ed55ac418762c',
    primary_color: '9e1a65',
    secondary_color: 'f593b9',
    enclosure_url:
      'https://api.breaker.audio/shows/185226/episodes/29314799/enclosure?v=45e6328326e21b2b53c8189ef2fdfa1f',
    ...
    show: {
      ...
      feed_url:
        'http://feeds.soundcloud.com/users/soundcloud:users:181343349/sounds.rss',
      hosted: false,
      image_url:
        'https://api.breaker.audio/shows/185226/image?v=8572f6185658e2e7ff77a46fb3ae41aa',
...
export default sampleBreakerData;